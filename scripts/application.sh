...
XBB_APPLICATION_NAME=${XBB_APPLICATION_NAME:-"GNU sed"}

# Used as part of file/folder paths.
XBB_APPLICATION_LOWER_CASE_NAME=${XBB_APPLICATION_LOWER_CASE_NAME:-"sed"}
...
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( sed libiconv )
