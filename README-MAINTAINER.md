...
file; the format is `4.9.0-1`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `4.9.0-1`).
...
- add a new entry like _* v4.9.0-1 prepared_
- commit with a message like _prepare v4.9.0-1_
...
```sh
xpm run build-develop --config darwin-x64 -C ~/Work/sed-xpack.git
```
...
total 256
-rw-r--r--  1 ilg  staff  125631 Dec 11 10:05 xpack-sed-4.9.0-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff     102 Dec 11 10:05 xpack-sed-4.9.0-1-darwin-x64.tar.gz.sha
```
...
xpm run build-develop --config darwin-arm64 -C ~/Work/sed-xpack.git
```
...
total 240
-rw-r--r--  1 ilg  staff  116149 Dec 11 10:09 xpack-sed-4.9.0-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff     102 Dec 11 10:09 xpack-sed-4.9.0-1-darwin-x64.tar.gz.sha
```
...
total 124
-rw-r--r-- 1 ilg ilg 120800 Dec 11 08:11 xpack-sed-4.9.0-1-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg    101 Dec 11 08:11 xpack-sed-4.9.0-1-linux-x64.tar.gz.sha
```
...
total 124
-rw-r--r-- 1 ilg ilg 118827 Dec 11 08:15 xpack-sed-4.9.0-1-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg    103 Dec 11 08:15 xpack-sed-4.9.0-1-linux-arm64.tar.gz.sha
```
...
total 116
-rw-r--r-- 1 ilg ilg 113420 Dec 11 08:15 xpack-sed-4.9.0-1-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg    101 Dec 11 08:15 xpack-sed-4.9.0-1-linux-arm.tar.gz.sha
```
...
```sh
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbli
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla64
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla32
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbmi
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbma
```
...
```sh
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-test-prime.sh
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-test-docker-linux-intel.sh
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-test-docker-linux-arm.sh
```
...
```sh
bash ~/Work/sed-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-travis-macos.sh
```
...
git -C ~/Work/sed-xpack.git pull
xpm run install -C ~/Work/sed-xpack.git
xpm run test-pre-release -C ~/Work/sed-xpack.git
```
...
- in `CHANGELOG.md`, add the release date and a message like _* v4.9.0-1 released_
...
tagged like **v4.9.0-1** (mind the dash in the middle!) and
named like **xPack GNU sed v4.9.0-1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GNU sed v4.9.0-1 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 4.9.0-1.1 release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v4.9.0-1.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v4.9.0-1.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 4.9.0-1.1`; the first 4 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/sed@4.9.0-1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/sed`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/sed@4.9.0-1.1`
...
- paste the release name like **xPack GNU sed v4.9.0-1 released**
