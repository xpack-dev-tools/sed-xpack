...
Use the new version, suffixed by `pre`, like `4.9.0-3.pre`.
...
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git
```
...
total 256
-rw-r--r--  1 ilg  staff  125721 Sep  6 15:18 xpack-sed-4.9.0-3-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff     102 Sep  6 15:18 xpack-sed-4.9.0-3-darwin-x64.tar.gz.sha
```
...
xpm run build-development --config darwin-arm64 -C ~/Work/xpack-dev-tools/sed-xpack.git
```
...
total 240
-rw-r--r--  1 ilg  staff  117880 Sep  6 15:18 xpack-sed-4.9.0-3-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff     104 Sep  6 15:18 xpack-sed-4.9.0-3-darwin-arm64.tar.gz.sha
```
...
xpm run docker-build-development --config linux-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git
```
...
total 124
-rw-r--r-- 1 ilg ilg 121902 Sep  6 12:18 xpack-sed-4.9.0-3-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg    101 Sep  6 12:18 xpack-sed-4.9.0-3-linux-x64.tar.gz.sha
```
...
xpm run docker-build-development --config linux-arm64 -C ~/Work/xpack-dev-tools/sed-xpack.git
```
...
total 124
-rw-r--r-- 1 ilg ilg 120087 Sep  6 12:20 xpack-sed-4.9.0-3-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg    103 Sep  6 12:20 xpack-sed-4.9.0-3-linux-arm64.tar.gz.sha
```
...
xpm run docker-build-development --config linux-arm -C ~/Work/xpack-dev-tools/sed-xpack.git
```
...
total 116
-rw-r--r-- 1 ilg ilg 114079 Sep  6 12:20 xpack-sed-4.9.0-3-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg    101 Sep  6 12:20 xpack-sed-4.9.0-3-linux-arm.tar.gz.sha
```
...
```sh
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-darwin-x64.yml
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-darwin-arm64.yml
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-linux-x64.yml
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-win32-x64.yml
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-linux-arm64.yml
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-linux-arm.yml
```
...
bash ~/Work/xpack-dev-tools/sed-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-test-docker-linux-x64.sh
