...
the **[Update the version specific code](http://localhost:3000/sed-xpack/docs/maintainer/#update-the-version-specific-code)** section.
...
```sh
rm -f ~/Work/xpack-dev-tools/sed-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/sed-xpack.git pull

xpm run install -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets

git -C ~/Work/xpack-dev-tools/xbb-helper-xpack.git pull
xpm link -C ~/Work/xpack-dev-tools/xbb-helper-xpack.git

xpm run link-deps -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets

xpm run deep-clean --config darwin-x64  -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets && \
xpm install --config darwin-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets && \
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
```
...
```sh
xpm run check-space -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
```
...
```sh
xpm run clear-all-projects-builds -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-test-prime -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
...
git -C ~/Work/xpack-dev-tools/sed-xpack.git pull
xpm run install -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
xpm run test-pre-release -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
```
...
this will add a file in the `website/blog` folder:
  ```sh
  xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/sed-xpack.git/build-assets
  ```
...
- add entries in the **Bug fixes**; use the following syntax
  ```
  - [[#N](https://github.com/xpack-dev-tools/sed-xpack/issues/N)]:
  ```
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/sed?activeTab=versions">npmjs.com</a>.
...
- open https://xpack-dev-tools.github.io/sed-xpack/docs/maintainer/#publish-the-website in a separate window
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fsed?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/sed/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fsed)](https://www.npmjs.com/package/@xpack-dev-tools/sed/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fsed)](https://www.npmjs.com/package/@xpack-dev-tools/sed/)
