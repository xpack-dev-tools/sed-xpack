...
# How to obtain help for xPack GNU sed
...
- Review the [GitHub Discussions](https://github.com/xpack-dev-tools/sed-xpack/discussions) for
similar topics
- Examine the [GitHub Issues](https://github.com/xpack-dev-tools/sed-xpack/issues)
tracker and the
...
others, please 
utilise the [GitHub Discussions](https://github.com/xpack-dev-tools/sed-xpack/discussions)
pages.
