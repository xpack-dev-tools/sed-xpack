...
title: Information for xPack GNU sed maintainers
...
```sh
bash ~/Work/xpack-dev-tools/sed-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack GNU sed v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/sed</code>
- <code>npm dist-tag add @xpack-dev-tools/sed@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/sed</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/sed@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/sed-xpack/blog/
...
- paste the release name like _**xPack GNU sed v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
