...
title: How to install the xPack GNU sed
...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fsed?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/sed/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/sed-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fsed?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/sed/)
...
- <code>xpack-sed-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-sed-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-sed-{customField('xpackVersion')}-linux-arm.tar.gz</code>
...
- <code>xpack-sed-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-sed-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
