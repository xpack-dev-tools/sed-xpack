...
The **xPack GNU sed** can be installed automatically, using the `xpm` command
...
<code>xpacks/@xpack-dev-tools/sed</code>.
...
* identify the platform specific archive for the latest available version
  of GNU sed, download it into a cache and unpack
...
* create a local symbolic link
  like <code>xpacks/@xpack-dev-tools/sed</code> pointing to the
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/sed@latest --global --verbose`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/sed /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/sed /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/sed /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`xpm uninstall @xpack-dev-tools/sed --verbose`
} </CodeBlock>
...
the <a href={ `https://github.com/xpack-dev-tools/sed-xpack/releases/` }>GitHub Releases</a> pages.
...
The Windows versions of **xPack GNU sed**
are packed as `.zip` files.
Download the latest version named like:

* <code>xpack-sed-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
...
To manually install the <b>xPack GNU sed</b>,
unpack the archive and move it to a location of your choice.

The recommended location is
the <code>%USERPROFILE%\\AppData\\Roaming\\xPacks\\sed</code> folder, for
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\sed\\xpack-sed-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>.
...
* <code>xpack-sed-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-sed-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
...
example <code>/Users/ilg/Library/xPacks/sed/xpack-sed-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/sed
cd ~/Library/xPacks/sed

tar xvf ~/Downloads/xpack-sed-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-darwin-x64.tar.gz
chmod -R -w xpack-sed-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
...
example <code>/home/ilg/.local/xPacks/sed/xpack-sed-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/sed
cd ~/.local/xPacks/sed

tar xvf ~/Downloads/xpack-sed-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-linux-x64.tar.gz
chmod -R -w xpack-sed-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
