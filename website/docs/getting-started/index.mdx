...
**xPack GNU sed** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of GNU sed,
intended for reproducible builds.

<Overview/>

The open source **xPack GNU sed** project is hosted on GitHub as
[`xpack-dev-tools/sed-xpack`](https://github.com/xpack-dev-tools/sed-xpack);
it provides the platform specific binaries as
[release assets](https://github.com/xpack-dev-tools/sed-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/sed-xpack/tree/xpack/build-assets/scripts).
...
[`sed-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/sed-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/sed-xpack/): It helps others discover our work.
