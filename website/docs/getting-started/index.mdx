...
**xPack GNU sed** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of GNU sed,
intended for reproducible builds.

<Overview/>

**xPack GNU sed** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/sed-xpack/tree/xpack/scripts).
